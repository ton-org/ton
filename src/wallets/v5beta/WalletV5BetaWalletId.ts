...
const walletV5BetaVersionsSerialisation: Record<
    WalletIdV5Beta["walletVersion"],
    number
> = {
    v5: 0,
};
export function loadWalletIdV5Beta(
...
export function storeWalletIdV5Beta(walletId: WalletIdV5Beta) {
    return (builder: Builder) => {
        ...
        builder.storeUint(
            walletV5BetaVersionsSerialisation[walletId.walletVersion],
            8,
        );
