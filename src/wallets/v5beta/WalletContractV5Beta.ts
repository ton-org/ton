...
export type WalletV5BetaPackedCell<T> = T extends WalletV5BetaSendArgsSignable
    ? Promise<Cell>
    : Cell;
...
export class WalletContractV5Beta implements Contract {
    ...
    async sendAddExtension(
        provider: ContractProvider,
        args: WalletV5BetaSendArgs & { extensionAddress: Address },
    ) {
     ...
     */
    async sendActionsBatch(
        provider: ContractProvider,
        args: WalletV5BetaSendArgs & { actions: OutActionWalletV5[] },
    ) {
     ...
     */
    createTransfer<T extends WalletV5BetaSendArgs>(
     ...
     */
    createAddExtension<T extends WalletV5BetaSendArgs>(
     ...
     */
    createRemoveExtension<T extends WalletV5BetaSendArgs>(
        args: T & { extensionAddress: Address },
    ): WalletV5BetaPackedCell<T> {
        return this.createRequest({
            ...args,
