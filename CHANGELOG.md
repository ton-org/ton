...
### Fixed
- Update axios to version 1.16.1
- Fixed behavior of createWalletTransfer* functions, which set too large validUntil for all wallets if seqno equals 0.
...
### Changed
- Updated CI/CD workflows for improved release automation
...
## Added
- Missing config param parsers (thx @Garrethta)
- Wallet constructors made public (thx [RSquad](https://rsquad.io))
...
## Added
- Plugin support in wallet v4 wrappers (thx @p0lunin)
